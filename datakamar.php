...
if (isset($_POST['tambahkamar'])) {
  ...
  $sql = "insert into kamar (Jenis_kamar, Harga, Keterangan) 
...
<div class="container">
<br><br>
<b><h3 class= "p-5">Tambah Data Kamar</h3></b>
<form method="post">
...
<center><button type="submit" class="btn btn-warning" name="tambahkamar">Tambah Data</button></center>
</div>
